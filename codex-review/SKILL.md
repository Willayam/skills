...
1. Identify the review target: uncommitted changes, base branch, commit SHA, PR checkout, or a specific implementation.
...
finding is real. In the user-facing response, separate confirmed issues from Codex suggestions
you did not verify.
